        ...
        <>
                        ...
                        <Popper open={true} anchorEl={anchorEl} placement='left-start'>
                            <Box className="bg-black rounded-3xl">
                                <List>
                                    ...
                                    <ListItemButton
                                        onClick={() => toggleArmyDetails(id, setActiveArmyViewers, activeArmyViewers)}>Details</ListItemButton>
                                </List>
                            </Box>
                        </Popper>
            ...
            {selectedCityId && showCityManager && (
                <div style={{position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 20}}>
                    <CityManager cityId={selectedCityId} primaryColor="black" secondaryColor="black"
                                 onClose={handleCloseCityManager}/>
                </div>
            )}
            ...
            >
                ...
                {armyImages.map((army, index) => (
                    <img key={index} src={army.src} alt="army" className="transition-all ease-linear"
                         style={{...army.style, left: `${army.curr_x * 100}%`, top: `${army.curr_y * 100}%`}}
