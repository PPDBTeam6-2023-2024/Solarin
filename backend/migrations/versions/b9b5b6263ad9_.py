...
Revision ID: b9b5b6263ad9
Revises: 
Create Date: 2024-04-01 15:59:20.575259
...
def upgrade() -> None:
    ...
    sa.Column('x', sa.Float(precision=53), nullable=False),
    sa.Column('y', sa.Float(precision=53), nullable=False),
    sa.Column('to_x', sa.Float(precision=53), nullable=False),
    sa.Column('to_y', sa.Float(precision=53), nullable=False),
